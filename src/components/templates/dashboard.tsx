                ...
                <div className="bg-background">
                    <div className="flex flex-col md:grid md:grid-cols-4 lg:grid-cols-5 h-screen">
                        ...
                        <div className="min-h-svh md:col-span-3  lg:col-span-4 lg:border-l bg-zinc-200 overflow-auto">
                            <div className="container px-0 md:px-8 md:w-4/5 flex items-start justify-around h-full ">
                                {isLoading ? (
                                    <div className="pt-24 ">
                                        <svg aria-hidden="true" className="w-32 h-32 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    isError ? <div className="w-full pt-8 md:pt-0 md:self-center px-2">
                                        <h2 className="text-2xl text-center sm:text-4xl">Oops... Algo deu errado!</h2>
                                        <img className="h-auto mx-auto md:max-w-md dark:shadow-gray-800" src={errorImg} alt="" />
                                    </div> :
